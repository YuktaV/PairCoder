...
function createDepsCommand(dependencies = {}) {
  ...
  const moduleManager =
    ...
    require("../../modules/manager").moduleManager;
  ...
  const deps = {
    ...
    options: [
      {
        flags: "-a, --add <dependency>",
        description: "Add dependency to module",
      },
      {
        flags: "-r, --remove <dependency>",
        description: "Remove dependency from module",
      },

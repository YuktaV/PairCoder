...
function createFocusCommand(deps = {}) {
  ...
  async function clearFocus() {
    try {
      ...
      console.log(
        chalk.green(`Focus cleared from module '${previousModule}'.`),
      );
  ...
  async function focusCmd(moduleName, options = {}) {
    try {
      ...
      console.log(
        chalk.green(
          `Focus set on module '${moduleName}' with ${level} detail level.`,
        ),
      );
      ...
      if (options.generate !== false) {
        console.log(
          chalk.blue(`Generating context for module '${moduleName}'...`),
        );
        ...
        console.log(
          chalk.green(
            `Context generated for module '${moduleName}' with ${result.tokenCount} tokens.`,
          ),
        );
  ...
  const focusCommand = {
    ...
    options: [
      ...
      {
        flags: "--no-generate",
        description: "Skip automatic context generation",
      },
